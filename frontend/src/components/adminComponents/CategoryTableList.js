...
const CategoryTableList = ({ currentItems }) => {
            ...
            <div className="sm:px-6 w-full">
                ...
                <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                    ...
                    <div className="sm:flex items-center justify-between">
                        ...
                        <div className=''>
                            <button onclick="popuphandler(true)" className="mr-4 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded">
                                <p className="text-sm font-medium leading-none text-white">Export All</p>
                            </button>
                            <button onclick="popuphandler(true)" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 mt-4 sm:mt-0 inline-flex items-start justify-start px-6 py-3 bg-indigo-700 hover:bg-indigo-600 focus:outline-none rounded">
                                <p className="text-sm font-medium leading-none text-white">Import</p>
                            </button>
                        </div>
