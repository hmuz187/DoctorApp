        ...
        <div>
            ...
            <div className="bg-white shadow rounded-lg p-4 ">
                <div className="mb-4 flex items-center justify-between">
                    <div>
                        <h3 className="text-xl font-bold text-gray-900 mb-2">Latest Post</h3>
                        <span className="text-base font-normal text-gray-500">This is a list of latest Post</span>
                    </div>
                            ...
                            <div className="shadow overflow-hidden sm:rounded-lg">
                                <table className="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody className="bg-white">
                                        <tr>
                                            <td className="p-4 whitespace-nowrap text-sm font-normal text-gray-900 font-semibold">
                                                Loang xuong khi man kinh
                                            </td>
