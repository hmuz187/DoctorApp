...
const Footer = () => {
  return (
    <div className='flex  justify-between  lg:px-[200px]  px-4 h-[65px] items-center  bg-[#1F1B4A] text-white'>
      <a href="https://www.twitter.com/eslam_D7" className='hover:text-[#00ACEE]'><h3 className='leading-6 lg:text-[18px] text-sm font- normal'>All rights reserved © ChanhLy Group</h3></a>
