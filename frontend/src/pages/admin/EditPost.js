...
import { PostItemExample } from './DataExamples'
...
const editConfig = {
    ...
    removePlugins: ["MediaEmbedToolbar", 'title-content'],
}
...
const EditPost = () => {
    ...
    const [title, setTitle] = useState(PostItemExample.title)
    const [content, setContent] = useState(PostItemExample.content)
    const [isPublish, setIsPublish] = useState(PostItemExample.isPublish)
    const [isDraft, setIsDraft] = useState(PostItemExample.isDraft)
