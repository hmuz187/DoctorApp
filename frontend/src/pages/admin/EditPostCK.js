...
const EditPostCK = () => {
    ...
    const examples = `<div class="ck ck-content ck-editor__editable ck-rounded-corners ck-editor__editable_inline ck-blurred" lang="en" dir="ltr" role="textbox" aria-label="Editor editing area: main" contenteditable="true"><h1 data-placeholder="Type your abstract">dsf</h1><p data-placeholder="Type your content">fdfsdf <i><strong><u>fsdfdfdggdg</u></strong></i></p></div>`
    const [originalFullContent, setOriginalFullContent] = useState()
    const [initData, setInitData] = useState(examples)
    ...
    return (
        <>
            {!isPreview ? (<>
                                ...
                                <div>
                                    <CKEditor
                                        ...
                                        onChange={(event, editor) => {
                                            ...
                                            // editor.data.htmlProcessor.domParser.parseFromString(originalFullContent)

                                            // if (insertData) {
                                            // const content = originalFullContent
                                            ...
                                            const substring2 = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 8"><path d="M9.055.263v3.972h-6.77M1 4.216l2-2.038m-2 2 2 2.038"></path></svg></div><div class="ck ck-widget__type-around__button ck-widget__type-around__button_after" title="Insert paragraph after block" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 8"><path d="M9.055.263v3.972h-6.77M1 4.216l2-2.038m-2 2 2 2.038"></path></svg>`
                ...
                <div>
                    <button onClick={() => { setIsPreview(!isPreview); setInitData(originalFullContent); }}>Back</button>
